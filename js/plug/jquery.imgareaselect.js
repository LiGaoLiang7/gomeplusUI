(function($) {
    ...
    $.imgAreaSelect = function(img, options) {
        var $img = $(img),
            ...
            zIndex = 0,
            position = 'absolute',
            startX, startY, scaleX, scaleY, resize, minWidth, minHeight, maxWidth, maxHeight, aspectRatio, shown, x1, y1, x2, y2, selection = {
                x1: 0,
                y1: 0,
                x2: 569,
                y2: 579,
        ...
        $p = $img;
        while ($p.length) {
            zIndex = max(zIndex, !isNaN($p.css('z-index')) ? $p.css('z-index') + 3 : zIndex);
    ...
    $.fn.imgAreaSelect = function(options) {
        ...
        this.each(function() {
            if ($(this).data('imgAreaSelect')) {
                ...
                var datas = new $.imgAreaSelect(this, options);
                $(this).data('imgAreaSelect', datas);
            }
        });
